...
} from "./chunk-LEJ77TWS.js";
import {
  Typography_default
} from "./chunk-KWHEVUIC.js";
import {
  useThemeProps
} from "./chunk-LR656QYN.js";
import "./chunk-FKGGVRPY.js";
import {
  ButtonBase_default,
  CSSTransition_default,
  TransitionGroup_default
} from "./chunk-4QMYEHJ2.js";
import {
...
import {
  createSvgIcon
} from "./chunk-W6SZUSVV.js";
import "./chunk-Z73R23EF.js";
import "./chunk-IQ4WJ5VD.js";
import {
  alpha,
  clsx_default,
  shouldForwardProp,
...
var PickerPopperPaperWrapper = React20.forwardRef((props, ref) => {
  const {
    PaperComponent,
    ownerState,
    children,
...
function PickerPopper(inProps) {
  ...
  const paperRef = React20.useRef(null);
...
var useControlledValue = ({
  ...
  const inputTimezone = React25.useMemo(() => valueManager.getTimezone(utils, valueWithInputTimezone), [utils, valueManager, valueWithInputTimezone]);
  ...
  const timezoneToRender = React25.useMemo(() => {
    if (timezoneProp) {
      return timezoneProp;
    }
    if (inputTimezone) {
  ...
  const valueWithTimezoneToRender = React25.useMemo(() => valueManager.setTimezone(utils, timezoneToRender, valueWithInputTimezone), [valueManager, utils, timezoneToRender, valueWithInputTimezone]);
...
function useValueAndOpenStates(parameters) {
  ...
  const {
    current: defaultValue
  } = React26.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React26.useRef(valueProp !== void 0);
  const {
  ...
  const viewValue = React26.useMemo(() => valueManager.cleanValue(utils, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [utils, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React27.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React27.useState(null);
  const popupRef = React27.useRef(null);
  ...
  const {
    ...
    viewModeLookup,
    timeViewsCount
  } = React27.useMemo(() => views.reduce((acc, viewForReduce) => {
  ...
  const [popperView, setPopperView] = React27.useState(currentViewMode === "UI" ? view : null);
  ...
  const ownerState = React27.useMemo(() => ({
  ...
  const triggerStatus = React27.useMemo(() => {
  ...
  const contextValue = React27.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React27.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React27.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
...
var PickersActionBar = React28.memo(PickersActionBarComponent);
...
var usePickerLayout = (props) => {
  ...
  const ownerState = React30.useMemo(() => _extends({}, pickerOwnerState, {
...
var PickersLayout = React31.forwardRef(function PickersLayout2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersLayout"
  });
  ...
  return (0, import_jsx_runtime9.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime9.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime9.jsxs)(React31.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime9.jsxs)(React31.Fragment, {
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React33.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React33.Fragment, {
  children: [(0, import_jsx_runtime10.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime10.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var PickersSectionList = React34.forwardRef(function PickersSectionList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime11.jsx)(React34.Fragment, {
...
var PickerTextFieldOwnerStateContext = React35.createContext(null);
if (true) PickerTextFieldOwnerStateContext.displayName = "PickerTextFieldOwnerStateContext";
var usePickerTextFieldOwnerState = () => {
  const value = React35.useContext(PickerTextFieldOwnerStateContext);
  if (value == null) {
...
var PickersInputBase = React36.forwardRef(function PickersInputBase2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInputBase"
  });
  ...
  const activeBarRef = React36.useRef(null);
  const sectionOffsetsRef = React36.useRef([]);
  const handleRootRef = useForkRef(ref, rootRef);
...
var PickersOutlinedInput = React38.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersOutlinedInput"
  });
  ...
  return (0, import_jsx_runtime14.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime14.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime14.jsxs)(React38.Fragment, {
        children: [label, " ", "*"]
      }) : label
    })
  }, other, {
...
var PickersFilledInput = React39.forwardRef(function PickersFilledInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersFilledInput"
  });
...
var PickersInput = React40.forwardRef(function PickersInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInput"
  });
...
var PickersTextField = React41.forwardRef(function PickersTextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersTextField"
  });
  ...
  const ownerState = React41.useMemo(() => _extends({}, fieldOwnerState, {
...
var PickerFieldUIContext = React42.createContext({
  slots: {},
  slotProps: {},
  inputRef: void 0
});
...
function PickerFieldUI(props) {
  ...
  const pickerFieldUIContext = React42.useContext(PickerFieldUIContext);
  const {
    textFieldProps,
    onClear,
    clearable,
...
var useFieldState = (parameters) => {
  ...
  const valueRef = React46.useRef(value);
  React46.useEffect(() => {
  ...
  const error = React46.useMemo(() => {
    if (errorProp !== void 0) {
      return errorProp;
    }
    return hasValidationError;
  }, [hasValidationError, errorProp]);
  const localizedDigits = React46.useMemo(() => getLocalizedDigits(utils), [utils]);
  const sectionsValueBoundaries = React46.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
  const getSectionsFromValue = React46.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    utils,
  ...
  const parsedSelectedSections = React46.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
  ...
  const areAllSectionsEmpty = React46.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  ...
  const sectionToUpdateOnNextInvalidDateRef = React46.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React47.useCallback((newValue, ctx) => {
    return setValue == null ? void 0 : setValue(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React47.useMemo(() => {
...
function useFieldHiddenInputProps(parameters) {
  ...
  const valueStr = React48.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  return {
    value: valueStr,
...
function useFieldSectionContainerProps(parameters) {
  ...
  const createHandleClick = React49.useCallback((sectionIndex) => (event) => {
    if (disabled || event.isDefaultPrevented()) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React49.useCallback((sectionIndex) => ({
...
function useFieldSectionContentProps(parameters) {
  ...
  const createFocusHandler = React50.useCallback((sectionIndex) => () => {
    if (disabled) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React50.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const sectionListRef = React51.useRef(null);
  const handleSectionListRef = useForkRef(sectionListRefProp, sectionListRef);
  const domGetters = React51.useMemo(() => ({
...
var useFieldV6TextField = (parameters) => {
  ...
  const openPickerAriaLabel = useOpenPickerButtonAriaLabel2(value);
  const sections = React52.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  ...
  const placeholder = React52.useMemo(() => {
    if (inPlaceholder !== void 0) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRtl);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRtl]);
  const valueStr = React52.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React52.useEffect(() => {
  ...
  const inputMode = React52.useMemo(() => {
    if (activeSectionIndex == null) {
      return "text";
    }
...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React57.useRef(createCalendarStateReducer(Boolean(reduceAnimations), utils)).current;
...
function usePickerDayOwnerState(parameters) {
  ...
  return React59.useMemo(() => _extends({}, pickerOwnerState, {
    day,
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React62.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
var MonthCalendarButton = React63.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var YearCalendarButton = React65.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
